...
private String nomeLogin = "Vitor Palazzo";
private String nomeSenha = "1234";
    ...
    private void validaLogin(){
     this.Loginzinho = txtUser.getText();
     this.Senhazinha = txtSenha.getText();
     if(Loginzinho.equals(nomeLogin)   &&  Senhazinha.equals(nomeSenha)){
     JOptionPane.showMessageDialog(this, "Logado com Sucesso!");
     new Principal().setVisible(true);
     dispose();
     }
    else
    JOptionPane.showMessageDialog(this, "Erro ao logar tente novamente!");
    }
